...
#Una segunda función debe recibir una lista y retornar el mayor y el menor valor
#de la lista. Desde el bloque principal del programa llamar a ambas funciones
